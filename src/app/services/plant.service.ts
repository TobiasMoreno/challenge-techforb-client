...
export class PlantService {
  ...
  updatePlant(plantId: string, updatedPlant: RequestPlant): Observable<void> {
    return this.baseService.http.put<void>(
      `${this.baseService.API_URL}/plants/${plantId}`,
      updatedPlant
    );
  }
  deletePlantById(plantId: string): Observable<void> {
    return this.baseService.http.delete<void>(
      `${this.baseService.API_URL}/plants/${plantId}`
    );
  }
}